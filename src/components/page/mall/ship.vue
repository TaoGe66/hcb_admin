<template>
    <div class="ship">
        ...
        <!--编辑list实体物品弹窗-->
        <el-dialog title="编辑物流信息" :visible.sync="dialogFormEdit" width="300px">
            <el-form :model="form">
...
<script type="text/ecmascript-6">
    export default {
        ...
        methods: {
            ...
            getData(){
                let self = this;
                self.$http.get("/shop/order/send/list").then((res) => {
            ...
            dialogFormEditYes(){
                ...
                this.$http.post('/shop/order/send',params).then((res)=>{
